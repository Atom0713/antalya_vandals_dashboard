...
export default function Event({ userRole }) {
  ...
  if (showAddAtandanceForm) return (
    <>
                      ...
                      <div className="preview-item border-bottom">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            ...
                            <p className="text-muted mb-0">Broadcast web app mockup ghbjnlkjdslvsjxfkgsdf</p>
                          </div>
                          <div className="me-auto text-sm-right pt-2 pt-sm-0">
                            <p className="text-muted">15 minutes ago ghdsfsdjghsdg</p>
