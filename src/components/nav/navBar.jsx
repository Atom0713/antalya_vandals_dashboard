    ...
    <nav className="navbar p-0 fixed-top d-flex flex-row">
        ...
        <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <li className="nav-item dropdown border-left">
                ...
                <a className="dropdown-item preview-item">
                    <div className="preview-thumbnail">
                    <img src="assets/images/faces/face4.jpg" alt="" className="rounded-circle profile-pic"/>
                    </div>
                    <div className="preview-item-content">
                ...
                <a className="dropdown-item preview-item">
                    <div className="preview-thumbnail">
                    <img src="assets/images/faces/face2.jpg" alt="" className="rounded-circle profile-pic"/>
                    </div>
                    <div className="preview-item-content">
                ...
                <a className="dropdown-item preview-item">
                    <div className="preview-thumbnail">
                    <img src="assets/images/faces/face3.jpg" alt="" className="rounded-circle profile-pic" />
                    </div>
                    <div className="preview-item-content">
            ...
            <li className="nav-item dropdown">
                ...
                <a className="dropdown-item preview-item">
                    ...
                    <div className="preview-item-content">
                    <button className="preview-subject mb-1" onClickCapture={logout}>Log out</button>
